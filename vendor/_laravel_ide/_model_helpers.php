...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereIsActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereViewCount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereMetaTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereMetaDescription($value)
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereSectionKey($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereSubtitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereImage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereLink($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereButtonText($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereIsActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereSortOrder($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereExtraData($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<HomeLayout>|HomeLayout timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class HomeLayout extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Portfolio>|Portfolio whereClient($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Portfolio>|Portfolio whereCompletedDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Portfolio>|Portfolio whereUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Portfolio>|Portfolio whereIsActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Portfolio>|Portfolio whereSortOrder($value)
